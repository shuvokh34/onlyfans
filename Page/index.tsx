    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Shuvokh34 <a href="https://shuvokh3.000webhostapp.com/">Alcash Zone</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://shuvokh3.000webhostapp.com/" className={styles.card}>
          ...
          <a
            href="https://shuvokh3.000webhostapp.com"
